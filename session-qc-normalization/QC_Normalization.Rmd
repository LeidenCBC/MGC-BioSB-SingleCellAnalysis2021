...
To do so we will convert the Seurat object to a [`SingleCellExperiment`](https://bioconductor.org/packages/devel/bioc/vignettes/SingleCellExperiment/inst/doc/intro.html) (SCE) object. 
...
We can subset SCE objects using the square brackets syntax, as we would subset a normal data frame or matrix.
